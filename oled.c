...
void OLED_Refresh(void)
{
	...
	for(i=0;i<4;i++)
	{
		OLED_WR_Byte(0xb0+i,OLED_CMD); //设置行起始地址ַ
...
//void OLED_ScrollDisplay1(void)
//{
//    static int x = 128;
//
//    OLED_Clear();
//
//    OLED_ShowChinese(x,0,3,16,1);        // 沃
//    OLED_ShowChinese(x + 16,0,4,16,1);  // 云
//
//    OLED_ShowString(x + 40,16,"WOYUN",16,1);
//
//    OLED_Refresh();
//
//    x--;
